...
How to Install: Click the button [![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/ak688/OneManager-php) to Deploy a new app, or create an app then deploy via connect to your github fork.  
